...
setup(
    name='Readmission',
    version='1.0',
    packages=['venv.Lib.site-packages.PIL', 'venv.Lib.site-packages.pytz', 'venv.Lib.site-packages.xlrd',
              'venv.Lib.site-packages.xlwt', 'venv.Lib.site-packages.numpy', 'venv.Lib.site-packages.numpy.ma',
              ...
              'venv.Lib.site-packages.scipy.fft', 'venv.Lib.site-packages.scipy.fft._pocketfft',
              'venv.Lib.site-packages.scipy.fft._pocketfft.tests', 'venv.Lib.site-packages.scipy.odr',
              'venv.Lib.site-packages.scipy.odr.tests', 'venv.Lib.site-packages.scipy._lib',
              'venv.Lib.site-packages.scipy._lib.tests', 'venv.Lib.site-packages.scipy._lib._uarray',
              ...
              'venv.Lib.site-packages.scipy._build_utils.tests', 'venv.Lib.site-packages.joblib',
              'venv.Lib.site-packages.joblib.test', 'venv.Lib.site-packages.joblib.test.data',
              'venv.Lib.site-packages.joblib.externals', 'venv.Lib.site-packages.joblib.externals.loky',
              'venv.Lib.site-packages.joblib.externals.loky.backend',
              ...
              'venv.Lib.site-packages.pandas.core.internals', 'venv.Lib.site-packages.pandas.core.array_algos',
              ...
              'venv.Lib.site-packages.pandas._libs.window', 'venv.Lib.site-packages.pandas.tests',
              ...
              'venv.Lib.site-packages.pandas.tests.io.pytables', 'venv.Lib.site-packages.pandas.tests.api',
              'venv.Lib.site-packages.pandas.tests.base', 'venv.Lib.site-packages.pandas.tests.util',
              'venv.Lib.site-packages.pandas.tests.frame', 'venv.Lib.site-packages.pandas.tests.frame.apply',
              'venv.Lib.site-packages.pandas.tests.frame.methods', 'venv.Lib.site-packages.pandas.tests.tools',
              'venv.Lib.site-packages.pandas.tests.arrays', 'venv.Lib.site-packages.pandas.tests.arrays.masked',
              'venv.Lib.site-packages.pandas.tests.arrays.sparse', 'venv.Lib.site-packages.pandas.tests.arrays.boolean',
              'venv.Lib.site-packages.pandas.tests.arrays.integer',
              ...
              'venv.Lib.site-packages.pandas.tests.series.apply', 'venv.Lib.site-packages.pandas.tests.series.methods',
              ...
              'venv.Lib.site-packages.pandas.tests.generic.methods', 'venv.Lib.site-packages.pandas.tests.groupby',
              'venv.Lib.site-packages.pandas.tests.groupby.aggregate',
              'venv.Lib.site-packages.pandas.tests.groupby.transform', 'venv.Lib.site-packages.pandas.tests.indexes',
              ...
              'venv.Lib.site-packages.pandas.tests.indexes.numeric',
              'venv.Lib.site-packages.pandas.tests.indexes.interval',
              'venv.Lib.site-packages.pandas.tests.indexes.datetimes',
              'venv.Lib.site-packages.pandas.tests.indexes.base_class',
              ...
              'venv.Lib.site-packages.pandas.plotting._matplotlib', 'venv.Lib.site-packages.seaborn',
              ...
              'venv.Lib.site-packages.sklearn._loss', 'venv.Lib.site-packages.sklearn._loss.tests',
              ...
              'venv.Lib.site-packages.sklearn.metrics._plot', 'venv.Lib.site-packages.sklearn.metrics._plot.tests',
              ...
              'venv.Lib.site-packages.sklearn.externals', 'venv.Lib.site-packages.sklearn.neighbors',
              'venv.Lib.site-packages.sklearn.neighbors.tests', 'venv.Lib.site-packages.sklearn.covariance',
              'venv.Lib.site-packages.sklearn.covariance.tests', 'venv.Lib.site-packages.sklearn.inspection',
              'venv.Lib.site-packages.sklearn.inspection._plot',
              'venv.Lib.site-packages.sklearn.inspection._plot.tests',
              'venv.Lib.site-packages.sklearn.inspection.tests', 'venv.Lib.site-packages.sklearn._build_utils',
              'venv.Lib.site-packages.sklearn.experimental', 'venv.Lib.site-packages.sklearn.experimental.tests',
              'venv.Lib.site-packages.sklearn.linear_model', 'venv.Lib.site-packages.sklearn.linear_model._glm',
              'venv.Lib.site-packages.sklearn.linear_model._glm.tests',
              ...
              'venv.Lib.site-packages.sklearn.cross_decomposition.tests', 'venv.Lib.site-packages.xgboost',
              ...
              'venv.Lib.site-packages.matplotlib.style', 'venv.Lib.site-packages.matplotlib.tests',
              ...
              'venv.Lib.site-packages.matplotlib.projections', 'venv.Lib.site-packages.matplotlip',
              'venv.Lib.site-packages.xlsxwriter', 'venv.Lib.site-packages.mpl_toolkits.tests',
